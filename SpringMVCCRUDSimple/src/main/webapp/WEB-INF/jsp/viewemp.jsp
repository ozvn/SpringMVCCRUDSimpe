...
<title>Bilgileri Görüntüle - OZVN</title>
						...
						<tbody>
							<tr>
								<td width="100%" height="100" align="center">
									...
									<table width="45%" cellpadding="1" align="center">
										<tr>
											<th>Id</th>
											<th>Adı</th>
											<th>Soyadı</th>
										...
										<c:forEach var="emp" items="${list}">
											<tr>
												...
												<td>${emp.phone}</td>
												<td>${emp.address}</td>
												<td><a href="editemp/${emp.id}">Düzenle</a></td>
												<td><a href="deleteemp/${emp.id}">Sil</a></td>
											</tr>
										</c:forEach>
									</table>
									...
									<tr>
										<td width="320" valign="middle" align="center">
											<table width="320" border="0" cellpadding="0" cellspacing="0"
												...
												<tbody>
													<tr>
														<td align="center" height="48"><a href="empform"
															style="display: block; text-decoration: none; text-align: center; border-radius: 5px; padding: 16px 20px; color: rgb(255, 255, 255); width: 280px; line-height: 16px; font-size: 14px; font-family: 'Open Sans', Helvetica, sans-serif; font-weight: 700; background-color: rgb(85, 183, 136)">
																Bilgilerini Kaydet </a></td>
											...
											<table width="320" border="0" cellpadding="0" cellspacing="0"
												...
												<tbody>
													<tr>
														<td align="center" height="48"><a href="index.jsp"
															style="display: block; text-decoration: none; text-align: center; border-radius: 5px; padding: 16px 20px; color: rgb(255, 255, 255); width: 280px; line-height: 16px; font-size: 14px; font-family: 'Open Sans', Helvetica, sans-serif; font-weight: 700; background-color: rgb(85, 183, 136)">
																Anasayfa </a></td>
